...
## Next Action
Run PROMPT_fix.md to address CRITICAL #1 (profile contamination). The father/son split is stable — now the profiling pipeline needs to correctly disambiguate which passages belong to each character.
