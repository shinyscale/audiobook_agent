...
1. **Priority 1:** Fix main_cast pipeline grounding failure (Issue #1) — this will likely resolve Issues #2, #3, and #8
2. **Priority 2:** Fix relationship label schema (Issue #4) — expand allowed relationship types
3. **Priority 3:** Fix profile extraction quality (Issues #5, #6, #7)
4. **Priority 4:** Pronunciation false positive filtering (Issue #9)
