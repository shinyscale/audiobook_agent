...
Run PROMPT_fix.md to implement cross-referencing of chapter summary `characters_present` with the character list to ensure Egaeus (and other characters identified in summaries) are added to the character list.
